...
public class Zombie extends JPanel implements ActionListener,KeyListener  {
	...
	public void paintComponent(Graphics g) {
		//mukhosht
			...
			g.fillRect(250, 210+105, 5, 105);
			g.fillRect(300,210+105, 5, 105);
				
			g.setColor(Color.green);
			
			for(int i=210+105;i<=210+210;i=i+21) {
			...
			for(int i=210;i<=210+105;i=i+21) {
			...
			for(int i=420;i<=630-105;i=i+21) {
			...
			g.fillRect(500,420+105,5, 105);
			g.fillRect(550,420+105,5, 105);
			
			g.setColor(Color.green);
		
			for(int i=420+105;i<=630+105;i=i+21) {
	...
	public void keyPressed(KeyEvent e) {
		...
		if((e.getKeyCode()==KeyEvent.VK_LEFT)&&((y>=560 &&y<=580)||(y>=350&&y<=370)||(y>=140&&y<=180))) {
		...
		if((e.getKeyCode()==KeyEvent.VK_RIGHT)&&((y>=560&&y<=580)||(y>=350&&y<=370)||(y>=140&&y<=180))) {
		...
		if((e.getKeyCode()==KeyEvent.VK_UP)&&(  (x>=500 &&x<=550)&&(y<=420+105-60 && y>=420+105+60) ||      (x>=900&&x<=950)&&(y<=590&&y>=360))||((x>=500&&x<=550)&&(y<=370&&y>=150))||((x>=100&&x<=150)&&(y<=160&&y>=0))) {
		...
		if((e.getKeyCode()==KeyEvent.VK_DOWN)&&(((x>=900&&x<=950)&&(y<=570&&y>=350))||((x>=500&&x<=550)&&(y<=350&&y>=140))||((x>=100&&x<=150)&&(y<=150&&y>=0)))) {
